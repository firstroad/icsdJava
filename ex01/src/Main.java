...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        do{
            ...
            if(option!=12) { System.out.print("Πατήστε Enter για να συνεχίσετε..."); in.nextLine(); }   
        }while(option!=12);
    }
    private static void add(){
        ...
        tabTitle(); 
        System.out.println(randomCode + ' ' + cars.get(randomCode)); 
    }
    ...
    private static void displayAll(){   
        tabTitle();
        for (String cur : cars.keySet()) {  
            System.out.println(cur + ' ' + cars.get(cur));   
        }
    }
