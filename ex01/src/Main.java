...
public class Main {
    ...
    public static void main(String[] args) {
        int option;
        do{
            cars.put("555", new car("Toyota", "Celica", 255, 2000, 15000, "White"));
            cars.put("435", new car("toyota", "starlet", 90, 1300, 3000, "Gray"));
            cars.put("123", new car("Alfa Romeo", "146", 80, 1600, 1000, "Red"));
            cars.put("000", new car("FIAT", "Cinquecento", 39, 900, 700, "Black"));
            cars.put("951", new car("fiat", "Punto", 55, 1400, 500, "Blue"));
            cars.put("754", new car("Subaru", "Impreza WRX STI 2005", 400, 2500, 20000, "Blue with Green Signs"));
